local return_code="%(?..%F{#df0015}%? ↵%f)"
local user_host=$'%B%(!.%F{#ac0607}.%F{#00a872})%n@%m%f '
local user_symbol='%(!.#.$)'
local current_dir="%B%F{#00b3e3}%~ %f"
...
KUBE_PS1_CTX_COLOR='160'
KUBE_PS1_NS_COLOR='29'
KUBE_PS1_SYMBOL_COLOR='37'
